      ...
      <div className="hidden lg:flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium truncate" title={stock.name}>
              {stock.name}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-5 text-sm flex-shrink-0">
          ...
          <div className="text-center min-w-[60px]">
            <p className="text-xs mb-0.5">Share amount</p>
          ...
          <div className="text-center min-w-[50px] mr-6">
            <p className="text-xs mb-0.5">Change</p>
          ...
          <div className="text-center  min-w-[100px]">
            <p className="text-xs mb-0.5">Current Value</p>
            <p className="font-medium">${stock.currentValue}</p>
          </div>
        </div>
      </div>
...
const MyPortfolioCard = memo(() => {
  ...
  return (
    <Card className="bg-primary/7 p-3 sm:p-4 h-90 lg:p-5 w-full overflow-hidden" role="region" aria-labelledby="my-portfolio-title">
      {/* Header - Responsive */}
      <div className="flex items-center justify-between">
        <h3 id="my-portfolio-title" className="text-sm sm:text-base font-semibold">
          My Portfolio
        </h3>
