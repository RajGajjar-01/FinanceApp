...
// Dummy pie data for consistent rendering
...
// Dummy accounts with complete data
...
const Tracker = () => {
  ...
  // Filter transactions for selected account (for demo, showing all)
  ...
  const handleAccountCreate = (newAccount) => {
    setAccounts((prev) => {
      // If new account is set as default, make all others non-default
      if (newAccount.isDefault) {
        const updatedAccounts = prev.map((acc) => ({ ...acc, isDefault: false }));
  ...
  const handleAccountSelection = (accountId) => {
    ...
    // Set the selected account as default and make others non-default
    setAccounts((prev) =>
      prev.map((acc) =>
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-4 space-y-4">
          ...
          <CardContent className="pt-0 pb-0 px-0">
            ...
            <div className="grid grid-cols-2 gap-1 pt-2 mt-2 border-t border-border">
              <div className="text-center">
                <p className="text-sm font-bold">${spent.toFixed(2)}</p>
                <p className="text-xs text-muted-foreground">Spent</p>
              </div>
              <div className="text-center">
                <p className="text-sm font-bold">${(budget - spent).toFixed(2)}</p>
            ...
            <CardHeader className="pb-2 pt-1 px-0">
              <div className="flex items-center justify-between">
                ...
                <Select
                  ...
                  onValueChange={handleAccountSelection} // Use new handler
                >
        ...
        <div className="grid gap-4 md:grid-cols-4">
          {/* Add New Account Card with Form */}
            ...
            >
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                {editingAccountId === account.id ? (
                  ...
                  <>
                    {/* Account Name with Pencil Icon directly after */}
